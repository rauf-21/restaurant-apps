...
export const main = el.bind(null, 'main');
export const footer = el.bind(null, 'footer');

export const div = el.bind(null, 'div');
export const span = el.bind(null, 'span');
export const section = el.bind(null, 'section');
...
export const form = el.bind(null, 'form');
export const label = el.bind(null, 'label');
...
export const figure = el.bind(null, 'figure');
export const blockquote = el.bind(null, 'blockquote');
export const figcaption = el.bind(null, 'figcaption');

export const dl = el.bind(null, 'dl');
export const dd = el.bind(null, 'dd');
export const dt = el.bind(null, 'dt');
